<%-- 
    Document   : updateCart
    Created on : Oct 29, 2020, 12:41:07 PM
    Author     : DELL
--%>
 ...
 <form name="form-product" action="update.jsp" method="post">
						<h4 id="productName" class="mtext-105 cl2 js-name-detail p-b-14">
							<%= product%>
                                                        ...
                                                        <input type="hidden" name="cart" value="<%= number %>" />
									...
									<div class="wrap-num-product flex-w m-r-20 m-tb-10">
										...
										<div class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m">
											<i class="fs-16 zmdi zmdi-plus"></i>
                                                                    ...
                                                                    <input type="submit" value="Update" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
...
<!--===============================================================================================-->
	...
	<script>
		...
		$('.js-addcart-detail').each(function(){
			...
			$(this).on('click', function(){
				swal(nameProduct, "item successfully updated !", "success");
			});
		});
