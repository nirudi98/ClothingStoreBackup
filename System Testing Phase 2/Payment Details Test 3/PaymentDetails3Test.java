...
import java.net.URL;
public class PaymentDetails3Test {
  ...
  public void paymentDetails3() {
    ...
    driver.findElement(By.name("card_no")).sendKeys("12345678");
    driver.findElement(By.name("date")).click();
    driver.findElement(By.name("date")).sendKeys("2020-12");
    driver.findElement(By.name("pin")).click();
    driver.findElement(By.name("pin")).sendKeys("456789");
    driver.findElement(By.cssSelector(".size-116")).click();
