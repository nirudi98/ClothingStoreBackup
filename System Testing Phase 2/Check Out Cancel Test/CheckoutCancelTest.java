...
import java.net.URL;
public class CheckoutCancelTest {
  ...
  public void checkoutCancel() {
    ...
    {
      WebElement dropdown = driver.findElement(By.name("size"));
      dropdown.findElement(By.xpath("//option[. = 'Size S']")).click();
    }
    driver.findElement(By.name("size")).click();
    driver.findElement(By.name("color")).click();
    {
    ...
    driver.findElement(By.linkText("update cart item")).click();
    driver.findElement(By.name("size")).click();
    {
      WebElement dropdown = driver.findElement(By.name("size"));
      dropdown.findElement(By.xpath("//option[. = 'Size S']")).click();
    ...
    driver.findElement(By.name("color")).click();
    driver.findElement(By.cssSelector(".p-t-33:nth-child(6) .size-204 > .flex-c-m")).click();
    driver.findElement(By.cssSelector(".stext-101 > a")).click();
    driver.findElement(By.xpath("(//input[@id=\'male\'])[2]")).click();
    driver.findElement(By.cssSelector(".size-116")).click();
    driver.findElement(By.name("c_id")).click();
    driver.findElement(By.name("c_id")).sendKeys("3");
    ...
    driver.findElement(By.name("card_no")).sendKeys("0985543");
    driver.findElement(By.name("date")).click();
    driver.findElement(By.name("date")).sendKeys("2020-10");
    driver.findElement(By.name("pin")).click();
    driver.findElement(By.name("pin")).sendKeys("787654");
    driver.findElement(By.cssSelector(".size-116")).click();
    driver.findElement(By.cssSelector("td:nth-child(3) > .flex-c-m")).click();
